...
public:
   ...
   void init()
   {
	...
	virtual void onACK(const int& ack, double receiver_timestamp __attribute((unused)), double sender_timestamp __attribute((unused)),int adjust_us __attribute((unused)) )
   {
      if (ack == m_iLastACK)
      {
         if (3 == ++ m_iDupACKCount)
